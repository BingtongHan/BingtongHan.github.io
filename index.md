...
- **Guolian Minsheng Securities Co.,Ltd. , Risk Management Department**, 2025.7-2025.8
  * Assist the team in constructing the credit rating model, including data query, data cleaning and variable derivation; participated in model validation and performance assessment.
  * Write research report to evaluate operational risk and debt repayment risk of the industries.
  * Designed a workflow for corporate sentiment analysis by LLM-based method, including rule-based classification and severity scoring.

- **Boston Consulting Group, Part-Time Assistant**, 2024.12-2025.5
  * Supported consulting project on e-commerce market expansion for audio products through meeting documentation, vendor due-diligence analysis, expert interviews, and store visits.
  * Synthesized market insights and contributed to strategy development to guide the client’s market expansion.
